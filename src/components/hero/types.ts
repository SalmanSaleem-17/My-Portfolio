...
export const SKILLS: Skill[] = [
  ...
  { name: 'JWT Authentication',    icon: Shield,     color: '#6366f1', bg: 'from-gray-100 to-slate-100' },
  { name: 'Socket.io Real-time',   icon: Zap,        color: '#f59e0b', bg: 'from-yellow-100 to-orange-100' },
