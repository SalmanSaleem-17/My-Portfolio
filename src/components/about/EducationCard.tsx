...
const EducationCard = memo(() => (
  <div
    className="relative bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-8 rounded-3xl
  ...
  >
    ...
    <div className="flex items-center gap-4 mb-6 relative z-10">
      <div className="animate-bounce p-3 bg-white rounded-2xl shadow-lg" style={{ animationDuration: '4s' }}>
