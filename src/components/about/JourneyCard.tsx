...
const JourneyCard = memo(() => (
  ...
  */
  <div
    className="relative backdrop-blur-sm p-8 rounded-3xl border border-white/20 dark:border-slate-600/30 shadow-2xl
  ...
  >
    ...
    <div className="flex items-center gap-3 mb-6">
      <div className="p-2 bg-linear-to-r from-blue-500 to-purple-500 rounded-lg transition-transform duration-200 hover:scale-110">
        <Code className="w-6 h-6 text-white" />
      </div>
      <h3 className="text-xl font-bold text-gray-800 dark:text-slate-200">My Journey</h3>
    </div>

    {/* Bio */}
    <p className="text-gray-700 dark:text-slate-300 leading-relaxed text-lg mb-6 font-medium">
    ...
    <p className="text-gray-700 dark:text-slate-300 leading-relaxed text-lg font-medium">
      ...
      <span className="bg-linear-to-r from-green-600 to-blue-600 bg-clip-text text-transparent font-bold">
