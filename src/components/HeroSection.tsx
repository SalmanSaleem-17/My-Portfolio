...
export default function HeroSection({}: HeroSectionProps) {
  ...
  const floatingIcons = useMemo(
    () => [Code, Database, Globe, Shield, Smartphone, Zap],
    []
  );
                ...
                >
                  <div className="flex items-center gap-2">
                    <div className="w-5 h-5 flex items-center justify-center">
                      {React.createElement(
                        skillsWithIcons[currentSkillIndex].icon,
                        {
                          className:
                            "w-5 h-5 transition-transform duration-300 hover:scale-110",
                          style: {
                            color: skillsWithIcons[currentSkillIndex].color,
                          },
                        }
                      )}
                    </div>
                ...
                {[
                  {
                    ...
                    text: "MERN Stack",
                    color:
                      "from-blue-100 to-cyan-100 text-blue-800 border-blue-200",
                  },
                  {
                    icon: GraduationCap,
                    text: "CS Graduate",
                    color:
                      "from-purple-100 to-violet-100 text-purple-800 border-purple-200",
                  },
                  {
                    icon: Star,
                    text: "Full-Stack",
          ...
          <div className="hidden lg:flex items-center gap-16 xl:gap-24">
            ...
            >
              ...
              >
                ...
                . Successfully built production-grade applications including
              ...
              >
                {[
                  ...
                  <a
                    ...
                    className={`
        flex items-center gap-3 text-gray-700 ${contact.bgColor}
        px-4 py-2 rounded-full shadow-md backdrop-blur-sm 
        transform transition-all duration-300 ease-out 
