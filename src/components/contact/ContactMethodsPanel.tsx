...
const ContactMethodsPanel = memo(() => (
  <div className="backdrop-blur-sm p-4 sm:p-8 rounded-xl sm:rounded-2xl
    shadow-lg border border-white/40 dark:border-slate-700/40" style={{ background: 'var(--card-bg)' }}>
